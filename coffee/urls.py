...
urlpatterns = [
    distill_path('', views.login_view, name='root', distill_func=get_login_view),  # Redirect root URL to login
    ...
    distill_path('about/', views.about, name='about', distill_func=get_about),
    distill_path('contact/', views.contact, name='contact', distill_func=get_contact),
